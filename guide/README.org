...
*** Applying the PCB to the electronical parts
    ...
    The two 2.2kΩ (Red Red Red Gold) pull-up resistors ensure the switches give a clear reading when open.
    [Read more about pull-up resistors here](https://learn.sparkfun.com/tutorials/pull-up-resistors).
